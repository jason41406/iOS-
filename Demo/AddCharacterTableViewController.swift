...
class AddCharacterTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func done(_ sender: Any) {
        ...
        print("\(nameTextField.text!) \(jobTextField.text!)")
        
        if nameTextField.text!.characters.count  == 0 || jobTextField.text!.characters.count == 0||heightTextField.text!.characters.count == 0||weightTextField.text!.characters.count == 0{
        ...
        let dic = ["name":nameTextField.text!,
                   ...
                   "height":heightTextField.text!,
                    "sex":sexSegment.selectedSegmentIndex == 0 ? "男" : "女"]
